...
<header class="site-header sticky-top py-1">
    <nav class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block" href="/collection">Коллекции</a>
        <a class="py-2 d-none d-md-inline-block" href="/goods">Товары</a>
        <a class="py-2 d-none d-md-inline-block" href="/show">Товары и коллекции</a>
